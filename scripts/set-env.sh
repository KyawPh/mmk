...
# Script to set Firebase Functions environment configuration
# Usage: ./scripts/set-env.sh

echo "Setting Firebase Functions environment configuration..."
...
echo ""
echo "To view the configuration, run:"
echo "  firebase functions:config:get"
echo ""
echo "To use in local development, run:"
echo "  firebase functions:config:get > functions/.runtimeconfig.json"
echo ""
echo "Note: Don't commit .runtimeconfig.json to version control!"